...
public class CommunicationModuleClient extends CommunicationModule{
    private DatagramSocket socket;
    private InetAddress ipAddress;
    
    CommunicationModuleClient(int port, String host){
        try{
    ...
    @Override
    public Reply receive() throws Exception{
        Reply msg = new Reply();
        try{
            ...
            msg = (Reply) in.readObject();
        } catch (IllegalArgumentException e){
            System.out.println("CommunicationModuleClient.java: 2");
